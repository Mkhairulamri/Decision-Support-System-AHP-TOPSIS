...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Data Kriteria Rapor</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <button type="button" class="btn btn-outline-warning btn-sm"
                                                data-toggle="modal" data-target="#edit{{ $sn->id }}">Edit</button>
...
@foreach ($subnilai as $sn)
    ...
    <div class="modal fade col-12" tabindex="-1" role="dialog" id="edit{{ $sn->id }}">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Data Nilai Rapor </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="needs-validation" novalidate="" action="{{ route('UpdateSubNilai', $sn->id) }}"
                        method="POST">
                        {{ csrf_field() }}
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control text-uppercase" required=""
                                        name="kode" value="{{ $sn->kode_subnilai }}" />
                                    <div class="invalid-feedback">
                                        Maaf Form Tidak Boleh Kosong
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Pelajaran</label>
                                <div class="col-sm-9">
                                    <select class="form-control select" style="width: 100%;"
                                        aria-label="Default select example" name="pelajaran">
                                        <option value="" selected>Pilih Mata Pelajaran Sub Nilai</option>
                                        <option value="BIND"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" id="semester" class="form-control" required=""
                                        name="semester" value="{{ $sn->semester }}" />
                                    <div class="invalid-feedback">
                                        Maaf Form Tidak Boleh Kosong
                                    </div>
                                </div>
